...
public class CmdEntryPoint extends ICmdEntryInterface.Stub {
    public static final String ACTION_START = "com.eltechs.ed.CmdEntryPoint.ACTION_START";
    public static final int PORT = 7992;
...
//        android.util.Log.i("CmdEntryPoint", "commit " + "xegw");
...
//    }
    ...
    CmdEntryPoint(String[] args, Context context){
        if (!start(args))
            System.exit(1);
    ...
    public static void sendStartSignalInAppProcess() {
        ...
        context.startService(new Intent(context, XegwConnectService.class));
    }
    ...
    public static void sendStopSignalInAppProcess() {
        Context context = Globals.getAppContext();
        context.stopService(new Intent(context, XegwConnectService.class));
