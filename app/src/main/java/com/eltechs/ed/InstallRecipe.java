...
public class InstallRecipe {
    public static final List<InstallRecipe> LIST = Arrays.asList(
            ...
            new InstallRecipe("Other app (not from the list)").setScreenInfo(new ScreenInfo(800, 600, 16)).setControls(new Civ3Controls()));
    ...
    private InstallRecipe setInstallScript(String str) {
        this.mInstallScriptName = str;
        return this;
    }

    private InstallRecipe setRunScript(String str) {
        this.mRunScriptName = str;
        return this;
    }

    private InstallRecipe setScreenInfo(ScreenInfo screenInfo) {
    ...
    private InstallRecipe setLocaleName(String str) {
        this.mLocaleName = str;
        return this;
    }

    private InstallRecipe setRunArguments(String str) {
        this.mRunArguments = str;
        return this;
    }

    private InstallRecipe setDownloadURL(String str) {
        this.mDownloadURL = str;
        return this;
    }

    private InstallRecipe setStartupActions(String... strArr) {
        this.mStartupActions = TextUtils.join(" ", strArr);
        return this;
    }

    private InstallRecipe setRunGuide(String str) {
        this.mRunGuide = str;
        return this;
    }
