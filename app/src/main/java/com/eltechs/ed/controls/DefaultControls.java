...
public class DefaultControls extends Controls {
    ...
    public static List<ControlsInfoElem> infoElem1 =Arrays.asList(
            ...
            new ControlsInfoElem(R.drawable.gesture_lclick, getS(RR.cmCtrl_gs_lClick).split("\\$")[0], getS(RR.cmCtrl_gs_lClick).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_rclick, getS(RR.cmCtrl_gs_rClick).split("\\$")[0], getS(RR.cmCtrl_gs_rClick).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_vscroll_wheel, getS(RR.cmCtrl_gs_vScroll).split("\\$")[0], getS(RR.cmCtrl_gs_vScroll).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_dnd_left, getS(RR.cmCtrl_gs_dndLeft).split("\\$")[0], getS(RR.cmCtrl_gs_dndLeft).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_zoom, getS(RR.cmCtrl_gs_zoom).split("\\$")[0], getS(RR.cmCtrl_gs_zoom).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_keyboard, getS(RR.cmCtrl_gs_keyboard).split("\\$")[0], getS(RR.cmCtrl_gs_keyboard).split("\\$")[1]),
            new ControlsInfoElem(R.drawable.gesture_menu, getS(RR.cmCtrl_gs_menu).split("\\$")[0], getS(RR.cmCtrl_gs_menu).split("\\$")[2]));
    public static List<ControlsInfoElem> infoElem2 = Arrays.asList(
            ...
            new ControlsInfoElem(R.drawable.gesture_move_cursor,getS(RR.cmCtrl_gs_moveCursor).split("\\$")[0],getS(RR.cmCtrl_gs_moveCursor).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_lclick, getS(RR.cmCtrl_gs_lClick).split("\\$")[0], getS(RR.cmCtrl_gs_lClick).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_rclick, getS(RR.cmCtrl_gs_rClick).split("\\$")[0], getS(RR.cmCtrl_gs_rClick).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_vscroll_wheel, getS(RR.cmCtrl_gs_vScroll).split("\\$")[0], getS(RR.cmCtrl_gs_vScroll).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_dnd_left, getS(RR.cmCtrl_gs_dndLeft).split("\\$")[0], getS(RR.cmCtrl_gs_dndLeft).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_zoom, getS(RR.cmCtrl_gs_zoom).split("\\$")[0], getS(RR.cmCtrl_gs_zoom).split("\\$")[2]),
            new ControlsInfoElem(R.drawable.gesture_menu, getS(RR.cmCtrl_gs_menu).split("\\$")[0], getS(RR.cmCtrl_gs_menu).split("\\$")[2]));
