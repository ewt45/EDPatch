...
//        assert getArguments() != null;
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        switchToCustom.setText(S.get(S.CstRsl_swtTxt));
...
//            preference.dialog
        ...
        }else if(preference.getKey().equals("SCREEN_SIZE")){
