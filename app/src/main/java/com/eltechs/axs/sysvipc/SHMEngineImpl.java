...
public class SHMEngineImpl implements SHMEngine {
    ...
    @Override // com.eltechs.axs.sysvipc.SHMEngine
    public AttachedSHMSegment attachSegment(int i, boolean z) {
        MappedByteBuffer mapAshmemSegment;
        try {
            ...
            if (wrap2.getInt() == 0 && (mapAshmemSegment = mapAshmemSegment(fileDescriptorArr[0], j, z)) != null) {
    ...
    public void detachSHMSegment(AttachedSHMSegment attachedSHMSegment) {
        ...
        attachedSHMSegmentImpl.size = -1L;
    }
}