...
public class XServerComponent extends EnvironmentComponent {
    ...
    private void startXConnector(XServer xServer) throws IOException {
        ...
        this.connector.setInitialInputBufferCapacity(262144);//0x40000
    ...
    private static KeyboardModel createKeyboardModel() {
        ...
        keyboardModifiersLayout.setKeycodeToModifier((byte) KeyCodesX.KEY_ALT_LEFT.getValue(), KeyButNames.ALT);
        keyboardModifiersLayout.setKeycodeToModifier((byte) KeyCodesX.KEY_ALT_RIGHT.getValue(), KeyButNames.ALT);
        keyboardModifiersLayout.setKeycodeToModifier((byte) KeyCodesX.KEY_NUM_LOCK.getValue(), KeyButNames.NUM_LOCK);
        keyboardModifiersLayout.setKeycodeToModifier((byte) KeyCodesX.KEY_CAPS_LOCK.getValue(), KeyButNames.CAPS_LOCK);
        keyboardModifiersLayout.setModifierSticky(KeyButNames.CAPS_LOCK, true);
        keyboardModifiersLayout.setModifierSticky(KeyButNames.NUM_LOCK, true);
