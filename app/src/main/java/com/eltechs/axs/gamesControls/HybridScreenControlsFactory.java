...
public class HybridScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    private void fillTouchScreenControls(TouchScreenControls touchScreenControls, View view, ViewOfXServer viewOfXServer) {
        ...
        if (view.getWidth() > displayMetrics.widthPixels / 2) {
            ...
            this.gestureContext = GestureMachineConfigurerHybrid.createGestureContext(viewOfXServer, touchArea, touchEventMultiplexor, displayMetrics.densityDpi, new Runnable() { // from class: com.eltechs.axs.gamesControls.HybridScreenControlsFactory.1_fix
