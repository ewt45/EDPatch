...
public class OxygenTouchScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    private void fillTouchScreenControls(TouchScreenControls touchScreenControls, View view, ViewOfXServer viewOfXServer) {
        ...
        this.gestureContext = GestureMachineConfigurerOxygen.createGestureContext(viewOfXServer, touchArea, touchEventMultiplexor, displayMetrics.densityDpi, () -> ((XServerDisplayActivity) ((ApplicationStateBase) Globals.getApplicationState()).getCurrentActivity()).showPopupMenu());
