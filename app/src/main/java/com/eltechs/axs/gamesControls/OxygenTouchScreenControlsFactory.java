...
public class OxygenTouchScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    private void fillTouchScreenControls(TouchScreenControls touchScreenControls, View view, ViewOfXServer viewOfXServer) {
        ...
        this.gestureContext = GestureMachineConfigurerOxygen.createGestureContext(viewOfXServer, touchArea, touchEventMultiplexor, displayMetrics.densityDpi, new Runnable() { // from class: com.eltechs.axs.gamesControls.OxygenTouchScreenControlsFactory.1
