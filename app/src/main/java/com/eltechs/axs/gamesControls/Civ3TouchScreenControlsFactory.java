...
public class Civ3TouchScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    public Civ3TouchScreenControlsFactory(GestureMouseMode gestureMouseMode) {
