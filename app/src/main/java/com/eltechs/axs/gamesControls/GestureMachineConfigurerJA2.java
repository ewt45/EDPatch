...
public class GestureMachineConfigurerJA2 {
    ...
    public static GestureContext createGestureContext(ViewOfXServer viewOfXServer, TouchArea touchArea, TouchEventMultiplexor touchEventMultiplexor, int i, Runnable runnable) {
        ...
        finiteStateMachine.setStatesList(gestureStateNeutral, gestureState1FingerMeasureSpeed, gestureStateCheckFingerNearToPointer, gestureStateCheckFingerNearToPointer2, gestureState1FingerToLongClick, gestureStateClickToFingerFirstCoords3, gestureStateClickToFingerFirstCoords2, gestureStateClickToFingerFirstCoords, gestureStateWaitFingersNumberChangeWithTimeout, gestureStateWaitFingersNumberChangeWithTimeout2, gestureStateMouseWarpToFingerLastCoords, gestureState1FingerMoveToScrollAsync, gestureStateCheckIfZoomed, fSMStateRunRunnable, gestureState1FingerMoveToMouseMove, gestureState1FingerToZoomMove, gestureState2FingersToZoom, gestureStateWaitForNeutral);
        ...
        finiteStateMachine.addTransition(gestureState1FingerMeasureSpeed, GestureState1FingerMeasureSpeed.FINGER_WALKED, gestureStateCheckFingerNearToPointer2);
        finiteStateMachine.addTransition(gestureState1FingerMeasureSpeed, GestureState1FingerMeasureSpeed.FINGER_FLASHED, gestureStateCheckFingerNearToPointer2);
        ...
        finiteStateMachine.addTransition(gestureStateWaitFingersNumberChangeWithTimeout, GestureStateWaitFingersNumberChangeWithTimeout.FINGER_RELEASED, gestureStateClickToFingerFirstCoords3);
        ...
        finiteStateMachine.addTransition(gestureStateCheckFingerNearToPointer, GestureStateCheckFingerNearToPointer.NEAR, gestureStateClickToFingerFirstCoords);
        finiteStateMachine.addTransition(gestureStateCheckFingerNearToPointer, GestureStateCheckFingerNearToPointer.FAR, gestureStateClickToFingerFirstCoords2);
        finiteStateMachine.addTransition(gestureStateCheckFingerNearToPointer2, GestureStateCheckFingerNearToPointer.NEAR, gestureState1FingerMoveToMouseMove);
        finiteStateMachine.addTransition(gestureStateCheckFingerNearToPointer2, GestureStateCheckFingerNearToPointer.FAR, gestureStateCheckIfZoomed);
