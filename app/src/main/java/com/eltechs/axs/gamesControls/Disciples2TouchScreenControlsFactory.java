...
public class Disciples2TouchScreenControlsFactory implements TouchScreenControlsFactory {
    ...
    private void fillTouchScreenControls(TouchScreenControls touchScreenControls, View view, ViewOfXServer viewOfXServer) {
        ...
        this.gestureContext = GestureMachineConfigurerDisciples2.createGestureContext(viewOfXServer, touchArea, touchEventMultiplexor, displayMetrics.densityDpi, new Runnable() { // from class: com.eltechs.axs.gamesControls.Disciples2TouchScreenControlsFactory.1
