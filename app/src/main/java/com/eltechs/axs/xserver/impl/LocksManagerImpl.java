...
public class LocksManagerImpl implements LocksManager {
    ...
    public static final class SingleXLock implements LocksManager.XLock {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public final class MultiXLock implements LocksManager.XLock {
        ...
        public MultiXLock(LocksManager.Subsystem[] subsystemArr) {
            ...
            EnumMap enumMap = LocksManagerImpl.this.locks;
            for (LocksManager.Subsystem subsystem : subsystemArr) {
                ((ReentrantLock) enumMap.get(subsystem)).lock();
            }
        }
        ...
        public void close() {
            ...
            for (int length = this.systems.length - 1; length >= 0; length--) {
                ((ReentrantLock) enumMap.get(this.systems[length])).unlock();
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static final class NullXLock implements LocksManager.XLock {
