...
//public class GestureState1FingerMoveToMouseMoveWithWait extends AbstractGestureFSMState implements TouchEventAdapter {
//    private Finger f;
//    private final MouseMoveAdapter moveAdapter;
//    private PointerContext pointerContext;
//    public static FSMEvent GESTURE_COMPLETED = new FSMEvent() { // from class: com.eltechs.axs.GestureStateMachine.GestureState1FingerMoveToMouseMoveWithWait.1_fix
//    };
//    public static FSMEvent FINGER_TOUCHED = new FSMEvent() { // from class: com.eltechs.axs.GestureStateMachine.GestureState1FingerMoveToMouseMoveWithWait.2_fix
//    };
//
...
//    }
//
//    public GestureState1FingerMoveToMouseMoveWithWait(GestureContext gestureContext, PointerContext pointerContext, MouseMoveAdapter mouseMoveAdapter) {
...
//        this.moveAdapter.prepareMoving(this.f.getX(), this.f.getY());
//    }
//
//    @Override // com.eltechs.axs.finiteStateMachine.FSMState
