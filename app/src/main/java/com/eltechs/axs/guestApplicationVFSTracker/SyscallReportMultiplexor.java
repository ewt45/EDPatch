...
public class SyscallReportMultiplexor implements SyscallReportHandler, Serializable {
    ...
    public boolean handleSyscall(SyscallReportData syscallReportData, XOutputStream xOutputStream) {
        Log.d("SYSCALL", String.format("Handling syscall for %d : nr : %d fl: %d", Integer.valueOf(syscallReportData.getFileIndex()), Integer.valueOf(syscallReportData.getSyscallNr()), Integer.valueOf(syscallReportData.getFlags())));
