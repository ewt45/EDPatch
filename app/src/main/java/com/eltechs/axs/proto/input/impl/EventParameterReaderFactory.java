...
public class EventParameterReaderFactory {
    public static RequestParamReadersFactory INSTANCE = new RequestParamReadersFactory() { // from class: com.eltechs.axs.proto.input.impl.EventParameterReaderFactory.1
