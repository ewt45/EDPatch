...
public class StateMouseMove extends GState implements TouchEventAdapter {
    ...
    public StateMouseMove(GestureContext gsContext, PointerContext ptCtxt, MouseMoveAdapter msMoveAdapter, boolean reportIfNewF,Map<String, Object> map) {
        super(gsContext, map);
...
//        this.moveAdapter.prepareMoving(this.f.getXWhenFirstTouched(), this.f.getYWhenFirstTouched());
    ...
    public static class SimpleBuilder {
        public com.example.datainsert.exagear.controls.axs.GestureStateMachine.State1FMouseMove create(GestureContext gestureContext, PointerContext pointerContext, boolean reportIfNewF) {
            return new com.example.datainsert.exagear.controls.axs.GestureStateMachine.State1FMouseMove(gestureContext, pointerContext,
