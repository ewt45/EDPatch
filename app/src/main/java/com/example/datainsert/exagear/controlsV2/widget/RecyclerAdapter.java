...
public abstract class RecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerAdapter.RegularViewHolder> {
    ...
    public static class RegularViewHolder extends RecyclerView.ViewHolder {
        ...
        public  LinearLayout twoLinesTextWrapper;
        public  TextView text1;
        public  TextView text2;
        public  ImageButton btnMenu;
        public  LinearLayout linearPart1;
        public  LinearLayout linearPart2;
        //备用视图，子类自定义的可以放这里
        public View stub1;
        public View stub2;
        public View stub3;
    ...
    //        relativeCheck.setOnClickListener(v -> imageView.performClick());
            ...
            twoLinesTextWrapper = new LinearLayout(c);
            twoLinesTextWrapper.setOrientation(LinearLayout.VERTICAL);
            twoLinesTextWrapper.setVerticalGravity(Gravity.CENTER);
            twoLinesTextWrapper.addView(text1,QH.LPLinear.one(-1,-2).left().to());
            twoLinesTextWrapper.addView(text2,QH.LPLinear.one(-1,-2).left().to());
            ...
            linearPart1 = new LinearLayout(c);
            linearPart1.setOrientation(LinearLayout.HORIZONTAL);
            linearPart1.setVerticalGravity(Gravity.CENTER_VERTICAL);
            linearPart1.addView(imageView, QH.LPLinear.one(dp8 * 6, dp8 * 6).left().to());
            linearPart1.addView(twoLinesTextWrapper, QH.LPLinear.one(0, dp8 * 6).weight().to());
